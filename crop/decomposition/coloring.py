...
if __name__ == '__main__':
    ...
    datasets = ["chebi", "kegg", "drugbank", "jamendo", "nytimes", "linkedmdb", "swdf", "geonames", "dbpedia"]
    ...
    for i in range(index):
        for j in range(i,index):
            if i != j:
                ...
                a_just_tp = False #True if False in [s_i.startswith("sparql@") for s_i in a.sources.keys()] else False
                b_just_tp = False #True if False in [s_i.startswith("sparql@") for s_i in b.sources.keys()] else False
